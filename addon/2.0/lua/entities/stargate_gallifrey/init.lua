...
ENT.Sounds = {
	Ring=Sound("stargate/gallifrey_roll.wav"),
	Ring2=Sound("stargate/gallifrey_spin.wav"),
	Open=Sound("stargate/gallifrey_open.wav"),
	Travel=Sound("stargate/gate_travel.mp3"),
	Close=Sound("stargate/gallifrey_close.wav"),
	Chevron=Sound("stargate/gallifrey_chevron2.wav"),
	Chevron2=Sound("stargate/gallifrey_chevron.wav"),
	Inbound=Sound("stargate/gallifrey_chevron2.wav"),
	Lock=Sound("stargate/gallifrey_chevron.wav"),
	LockInbound=Sound("stargate/gallifrey_chevron.wav"),
	Fail=Sound("stargate/gallifrey_failure.wav"),
	OnButtonLock=Sound("stargate/gallifrey_chevron.wav"),
}
...
function ENT:Initialize()
	...
	self.Entity:SetSubMaterial(0, "arcadia/gallifrey_stargate/base_sg")
	self.Entity:SetSubMaterial(1, "arcadia/gallifrey_stargate/glyphs_sg")
	self.Entity:SetSubMaterial(2, "arcadia/gallifrey_stargate/chev_sg")
	self.Entity:SetSubMaterial(3, "arcadia/gallifrey_stargate/glyphs_off_sg")
	self.Entity:SetSubMaterial(4, "arcadia/gallifrey_stargate/side_sg")
	self.Entity:SetSubMaterial(5, "arcadia/gallifrey_stargate/inner_sg")
	self.Entity:SetSubMaterial(6, "arcadia/gallifrey_stargate/glyphs_on_sg")
...
function ENT:SpawnFunction(p,t)
	...
	local e = ents.Create("stargate_gallifrey");
...
function ENT:AddRing()
	...
	for i=1,2 do
		...
		e:SetMaterial("arcadia/gallifrey_stargate/glyphs_on_sg")
		self.Ring.Dial[i] = e;
		e = nil;
...
*/
		e:SetSubMaterial(4,"arcadia/gallifrey_stargate/chev_sg")
		e:SetSubMaterial(5,"arcadia/gallifrey_stargate/light_back_sg")
		e:SetSubMaterial(6,"arcadia/gallifrey_stargate/light_off_sg")
		e:SetSubMaterial(7,"arcadia/gallifrey_stargate/light_on_sg")
	end
end
...
if (StarGate and StarGate.CAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "stargate_gallifrey", StarGate.CAP_GmodDuplicator, "Data" )
end